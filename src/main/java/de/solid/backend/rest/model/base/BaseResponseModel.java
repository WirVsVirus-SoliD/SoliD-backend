...
public abstract class BaseResponseModel<M, E extends AbstractEntity>
		extends
			BaseModel {
	...
	/**
	 * convert given entity to response model class - mapping the attributes of
	 * the given entity to the response model
	 * 
	 * @param entity
	...
	public M fromEntity(E entity) {
		...
		throw new RuntimeException(String.format(
				"Cannot instantiate model for entity class %s with id %s",
				entityType, entity.getT_id()));
	}
